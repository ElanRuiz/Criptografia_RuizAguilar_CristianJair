...
def cifrar_homofono(palabra, tabla):
    ...
    for letra in palabra.upper():
        if letra in tabla:
            ...
            palabra_cifrada.append(letra)  # Si la letra no está en la tabla, se deja igual
    return ' '.join(palabra_cifrada)

# Ejemplo de cifrado
palabra = "Hola, Como te llamas"
...
mensaje_cifrado = "00101101 01100010 01001011 00101010"  # Suponiendo que este es el cifrado de "HOLA"
descifrado = descifrar_homofono(mensaje_cifrado, tabla_inversa)

print("Mensaje descifrado:", palabra)
